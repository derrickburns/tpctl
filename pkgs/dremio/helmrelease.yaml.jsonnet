...
local helmrelease(me) = k8s.helmrelease(me, { version: lib.getElse(me, 'version', '0.7.0'), repository: 'https://raw.githubusercontent.com/tidepool-org/tidepool-helm/master/' }) {
  spec+: {
    values+: {
      distStorage: {
        type: "aws",
