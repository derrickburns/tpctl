            ...
            properties: {
              ...
              spec: {
                ...
                properties: {
                  ...
                  nodeCount: {
                    description: 'NodeCount defines how many nodes the Kibana deployment must have.',
                    format: 'int32',
                    type: 'integer',
                  },
                  secureSettings: {
                    description: 'SecureSettings references secrets containing secure settings, to be injected into Kibana keystore on each node. Each individual key/value entry in the referenced secrets is considered as an individual secure setting to be injected. You can use the `entries` and `key` fields to consider only a subset of the secret entries and the `path` field to change the target path of a secret entry key. The secret must exist in the same namespace as the Kibana resource.',
                    items: {
                      properties: {
                        entries: {
            ...
            properties: {
              ...
              spec: {
                ...
                properties: {
                  ...
                  count: {
                    description: 'Count defines how many nodes the Kibana deployment must have.',
                    format: 'int32',
                    type: 'integer',
                  },
                  elasticsearchRef: {
