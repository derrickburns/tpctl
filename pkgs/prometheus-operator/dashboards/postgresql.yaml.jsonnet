...
local dashboardConfig = {
  ...
  panels: [
    ...
    },
    {
      ...
      tableColumn: '{endpoint="http", instance="10.47.40.160:9187", job="postgres-exporter-prometheus-postgres-exporter", namespace="monitoring", pod="postgres-exporter-prometheus-postgres-exporter-79d477959f-c97bl", server="rds.amazon:5432", service="postgres-exporter-prometheus-postgres-exporter"}',
      targets: [
        {
  ...
  templating: {
    list: [
      ...
      },
      {
        ...
        current: {
          selected: false,
          text: '10.47.40.160:9187',
          value: '10.47.40.160:9187',
        },
        datasource: 'Prometheus',
        definition: '',
        hide: 0,
...
local configmap(me) = grafana.dashboard(me, 'postgresql-overview', dashboardConfig);
