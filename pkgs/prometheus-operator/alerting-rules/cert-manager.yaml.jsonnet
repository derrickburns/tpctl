    ...
    rules: [
      {
        ...
        annotations: {
          ...
          description: 'The certificate {{ $labels.exported_namespace }}/{{ $labels.name }} is expiring within 3 weeks.',
          dashboard_url: 'https://grafana.%s/d/u6M5igpWk/cert-manager?orgId=1' % me.config.cluster.metadata.domain,
        },
      ...
      },
      {
        ...
        annotations: {
          ...
          description: 'The certificate {{ $labels.exported_namespace }}/{{ $labels.name }} is not ready.',
          dashboard_url: 'https://grafana.%s/d/u6M5igpWk/cert-manager?orgId=1' % me.config.cluster.metadata.domain,
        },
