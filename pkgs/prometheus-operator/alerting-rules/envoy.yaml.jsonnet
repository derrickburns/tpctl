    ...
    rules: [
      {
        ...
        annotations: {
          ...
          dashboard: 'https://grafana.%s/d/gloo_upstreams/gloo-upstreams?orgId=1&refresh=5s&var-upstream={{ $labels.envoy_cluster_name }}&var-proxy=All' % me.config.cluster.metadata.domain,
        },
